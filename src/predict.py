...
def predict_image(img_path, save_for_review=True):
    ...
    if save_for_review:
        ...
        # Copy image
        os.rename(img_path, review_img_path)  # move instead of copy
        # Save JSON metadata
...
if __name__ == "__main__":
    ...
    print("\n" + "-" * 60)
    print("Prediction complete! Files moved to storage/to_review/")
